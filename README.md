...
##Repository Content
-**DataScienceEcosystem.ipynb** — Jupyter Notebook with:
- Using Markdown and Code cell
- Using Tables
- Examples like Solving Arithmetic equation
- All coursera Exercise Solution on the given assignment
  
##Purpose of this Repository
- Submission for Coursera assignment
- Practice using GitHub
- Practice working on Jupyter Notebook
